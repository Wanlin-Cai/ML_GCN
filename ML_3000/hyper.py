...
common_hyperparameters = {
    'lr': hp.uniform('lr', low=9e-5, high=1e-3),
    'weight_decay': hp.uniform('weight_decay', low=1e-8, high=1e-6),
    'patience': hp.choice('patience', [100]),
    'batch_size': hp.choice('batch_size', [16, 32, 64]),
}

gcn_hyperparameters = {
    'gnn_hidden_feats': hp.choice('gnn_hidden_feats', [64, 96, 128, 196, 256]),
    'predictor_hidden_feats': hp.choice('predictor_hidden_feats', [64, 96, 128, 196, 256]),
    'num_gnn_layers': hp.choice('num_gnn_layers', [3, 4, 5, 6]),
    'residual': hp.choice('residual', [True]),
    'batchnorm': hp.choice('batchnorm', [True]),
    'dropout': hp.uniform('dropout', low=0., high=0.5)
}
...
mpnn_hyperparameters = {
    'node_out_feats': hp.choice('node_out_feats', [64, 96, 128, 196, 256]),
    'edge_hidden_feats': hp.choice('edge_hidden_feats', [64, 96, 128, 196, 256]),
    'num_step_message_passing': hp.choice('num_step_message_passing', [3, 4, 5, 6, 7]),
    'num_step_set2set': hp.choice('num_step_set2set', [2, 3, 4, 5, 6]), 
    'num_layer_set2set': hp.choice('num_layer_set2set', [2, 3, 4, 5, 6])
}
